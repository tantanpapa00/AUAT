# patch_force_poll_wrapper_v4.py
# Usage:
#   cd C:\autobot
#   python .\patch_force_poll_wrapper_v4.py
...
def die(msg: str) -> None:
    print(f"[patch-force-wrapper-v4] ERROR: {msg}", file=sys.stderr)
    sys.exit(1)
...
""".lstrip("\n")
    ...
    print("[patch-force-wrapper-v4] OK")
    print(f"[patch-force-wrapper-v4] main.py -> {MAIN} (backup: {bak.name})")
