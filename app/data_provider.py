...
async def get_etf_overview():
    ...
    # === 테마 분류를 위한 키워드 매핑 (50개+ 확장) ===
    THEME_KEYWORDS = {
        # ========== 섹터/산업 ==========
        "반도체": ["반도체", "SOX", "필라델피아", "semiconductor", "HBM", "파운드리", "하이닉스"],
        "AI": ["AI", "인공지능", "ChatGPT", "빅데이터", "클라우드", "머신러닝", "딥러닝"],
        "빅테크": ["빅테크", "테크TOP", "테크10", "테크100", "메가테크"],
        "로봇": ["로봇", "자율주행", "드론", "UAM", "로보틱스", "자동화", "휴머노이드"],
        "2차전지": ["2차전지", "배터리", "리튬", "에코프로", "EV", "전고체"],
        "바이오": ["바이오", "헬스케어", "제약", "게놈", "의료기기", "신약", "mRNA"],
        "금융": ["금융", "은행", "보험", "금융지주", "핀테크"],
        "증권": ["증권"],
        "에너지": ["에너지", "신재생", "태양광", "풍력", "수소", "친환경"],
        "원자력": ["원자력", "우라늄", "원전", "SMR"],
        "우주항공": ["우주", "항공"],
        "방산": ["방산", "K방산", "국방", "위성", "방위"],
        "조선": ["조선", "해운", "컨테이너", "해양"],
        "자동차": ["자동차", "모빌리티", "전기차부품"],
        "건설·인프라": ["건설", "인프라", "SOC", "시멘트"],
        "철강·소재": ["철강", "소재", "화학", "정유", "석유화학"],
        "게임·미디어": ["게임", "엔터", "미디어", "콘텐츠", "K-POP", "OTT", "KPOP"],
        "식품": ["식품", "음식", "농산물", "F&B"],
        "AI전력": ["AI전력", "전력인프라", "데이터센터", "전력설비", "변압기"],
        "양자컴퓨팅": ["양자", "퀀텀", "quantum"],
        "테슬라": ["테슬라", "Tesla"],
        "소프트웨어": ["소프트웨어", "SW", "클라우드"],
        "사이버보안": ["사이버보안", "보안", "시큐리티", "Security", "정보보안"],
        "메타버스": ["메타버스", "VR", "AR", "가상현실"],
        "여행레저": ["여행", "레저", "관광", "호텔", "항공사"],
        "BBIG": ["BBIG"],
        # ========== 투자전략 ==========
        "인버스": ["인버스", "곱버스", "숏", "베어", "inverse"],
        "레버리지": ["레버리지", "2X", "3X", "leverage"],
        "배당": ["배당", "고배당", "월배당", "인컴", "dividend"],
        "커버드콜": ["커버드콜", "covered", "프리미엄인컴", "타겟커버드콜", "고정커버드콜"],
        "버퍼형": ["버퍼", "Buffer", "하방보호"],
        "Cash Cows": ["Cash Cows", "캐시카우", "현금흐름"],
        "로우볼": ["로우볼", "저변동", "LowVol", "저변동성"],
        "밸류": ["밸류", "가치주", "Value"],
        "퀄리티": ["퀄리티", "Quality", "우량회사채"],
        "밸류업": ["밸류업", "ValueUp"],
        "TDF": ["TDF", "타겟데이트"],
        "성장주": ["성장주", "그로스", "Growth"],
        "모멘텀": ["모멘텀", "Momentum"],
        # ========== 지역/국가 ==========
        "미국지수": ["S&P", "나스닥", "NASDAQ", "다우", "Russell", "미국대형", "미국500"],
        "중국": ["중국", "차이나", "CSI", "항셍", "HSCEI", "상해", "심천"],
        "일본": ["일본", "닛케이", "니케이", "TOPIX"],
        "유럽": ["유럽", "유로", "EURO", "독일", "DAX", "영국"],
        "인도": ["인도", "Nifty", "니프티", "India"],
        "신흥국": ["베트남", "신흥", "이머징", "브라질", "멕시코", "동남아"],
        "글로벌": ["글로벌", "선진국", "월드", "World", "MSCI", "토탈월드"],
        # ========== 원자재/통화 ==========
        "금": ["골드", "Gold", "금선물", "금액티브"],
        "은": ["실버", "Silver", "은선물", "귀금속"],
        "구리": ["구리", "Copper", "구리실물"],
        "원유": ["원유", "WTI", "크루드", "오일", "Crude"],
        "천연가스": ["천연가스", "가스", "Natural Gas"],
        "달러": ["달러", "USD", "Dollar", "미국달러", "달러선물"],
        "엔화": ["엔화", "JPY", "엔노출"],
        "위안화": ["위안", "CNY", "CNH", "중국위안", "위안화"],
        "VIX": ["VIX", "변동성", "공포지수", "Volatility"],
        "농산물": ["농산물", "옥수수", "밀", "대두", "커피", "설탕", "곡물"],
        # ========== 채권/단기금융 ==========
        "채권": ["국채", "회사채", "단기채", "장기채", "30년국채", "10년국채", "국고채", "Enhanced", "종합채권", "채권혼합", "채권액티브", "하이일드", "국공채"],
        "특수채": ["특수채", "전단채"],
        "머니마켓": ["머니마켓", "CD금리", "통안채", "KOFR", "CD1년"],
        "단기채권": ["단기", "초단기", "3개월"],
        # ========== 기타 ==========
        "리츠": ["리츠", "부동산", "REITs", "오피스", "물류센터"],
        "우선주": ["우선주"],
        "명품": ["명품", "럭셔리", "글로벌브랜드", "프리미엄소비"],
        "탄소배출권": ["탄소배출권", "탄소", "Carbon", "배출권"],
        "ESG": ["ESG", "친환경", "탄소중립"],
        "화장품": ["화장품", "뷰티", "K-뷰티"],
        ...
        "중공업": ["중공업", "기계"],
        # ========== 지수/시장 ==========
        "코스피200": ["코스피", "KOSPI", "코스피100", "코스피200", "200선물", "200TR", " 200", "200액티브"],
        "코스닥150": ["코스닥", "KOSDAQ", "코스닥150"],
        "KRX": ["KRX", "KRX300"],
        "IT섹터": ["200 IT", " IT", "정보기술"],
        # ========== 그룹주 ==========
        "삼성그룹": ["삼성그룹", "삼성전자"],
        ...
        "포스코그룹": ["포스코그룹", "포스코"],
        "지주회사": ["지주회사"],
        "코리아TOP": ["코리아TOP", "Top5Plus", "TOP10", "K수출"],
        # ========== 추가 ==========
        "설비투자": ["설비투자", "CAPEX"],
        "수출": ["수출", "무역"],
        "전략산업": ["전략산업", "핵심기업"],
...
# =============================================================================
# Phase 9: 해외 종목 상세 (yfinance 기반 - Finviz 완전 제거)
# =============================================================================


def _fetch_yfinance_stock_info(ticker: str) -> dict:
    """yfinance로 종목 상세 정보 조회 (동기)"""
    ...
    try:
        ...
        # 기본 정보
        data["name"] = info.get("shortName", info.get("longName", ticker))
        ...
        if market_cap >= 1e12:
            data["market_cap"] = f"{market_cap / 1e12:.2f}T"
        elif market_cap >= 1e9:
            data["market_cap"] = f"{market_cap / 1e9:.2f}B"
        elif market_cap >= 1e6:
            data["market_cap"] = f"{market_cap / 1e6:.2f}M"
        else:
            data["market_cap"] = str(market_cap)

        # 재무 지표
        data["per"] = info.get("trailingPE", 0) or 0
        data["forward_per"] = info.get("forwardPE", 0) or 0
        data["pbr"] = info.get("priceToBook", 0) or 0
        data["eps"] = info.get("trailingEps", 0) or 0
        data["roe"] = (info.get("returnOnEquity", 0) or 0) * 100  # 비율 → %
        data["roa"] = (info.get("returnOnAssets", 0) or 0) * 100
        data["dividend_yield"] = (info.get("dividendYield", 0) or 0) * 100
        data["debt_equity"] = info.get("debtToEquity", 0) or 0
        data["operating_margin"] = (info.get("operatingMargins", 0) or 0) * 100
        data["profit_margin"] = (info.get("profitMargins", 0) or 0) * 100

        # 52주 고저
        data["high_52w"] = info.get("fiftyTwoWeekHigh", 0) or 0
        data["low_52w"] = info.get("fiftyTwoWeekLow", 0) or 0

        # 거래량
        data["volume"] = info.get("volume", info.get("regularMarketVolume", 0)) or 0
        data["avg_volume"] = info.get("averageVolume", info.get("averageVolume10days", 0)) or 0

        # 애널리스트
        data["target_price"] = info.get("targetMeanPrice", 0) or 0
        data["recommendation"] = info.get("recommendationKey", "")

    except Exception as e:
        print(f"[yfinance] Stock info error for {ticker}: {e}")
...
async def get_stock_summary_us(ticker: str) -> dict:
    ...
    try:
        ...
        data = await loop.run_in_executor(None, _fetch_yfinance_stock_info, ticker)
        result.update(data)
...
def _fetch_yfinance_news(ticker: str, limit: int = 20) -> list:
    """yfinance로 종목 뉴스 조회 (동기)"""
    import yfinance as yf
...
async def get_stock_news_us(ticker: str, limit: int = 20) -> dict:
    ...
    try:
        loop = asyncio.get_event_loop()
        news_items = await loop.run_in_executor(None, _fetch_yfinance_news, ticker, limit)
