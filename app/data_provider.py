...
async def get_etf_overview():
    ...
    # === 테마 분류를 위한 키워드 매핑 (ETFCheck 기준 40개+) ===
    THEME_KEYWORDS = {
        # 섹터/산업
        "반도체": ["반도체", "SOX", "필라델피아", "semiconductor", "HBM", "파운드리"],
        "AI": ["AI", "인공지능", "ChatGPT", "빅데이터", "클라우드", "머신러닝"],
        "로봇": ["로봇", "자율주행", "드론", "UAM", "로보틱스", "자동화"],
        "2차전지": ["2차전지", "배터리", "리튬", "에코프로", "전기차", "EV", "전고체"],
        "바이오": ["바이오", "헬스케어", "제약", "게놈", "의료기기", "신약", "mRNA"],
        "금융": ["금융", "은행", "증권", "보험", "금융지주", "핀테크"],
        "에너지": ["에너지", "신재생", "태양광", "풍력", "수소"],
        "원자력": ["원자력", "우라늄", "원전", "SMR", "핵"],
        "우주항공": ["우주", "항공", "방산", "K방산", "국방", "위성"],
        "조선": ["조선", "해운", "LNG선", "컨테이너"],
        "자동차": ["자동차", "모빌리티", "현대차", "전기차부품"],
        "건설·인프라": ["건설", "인프라", "SOC", "시멘트"],
        "철강·소재": ["철강", "소재", "화학", "정유", "석유화학"],
        "게임·미디어": ["게임", "엔터", "미디어", "콘텐츠", "K-POP", "OTT"],
        "식품": ["식품", "음식", "농산물", "F&B"],
        "AI전력": ["AI전력", "전력인프라", "데이터센터", "전력설비", "변압기"],
        # 투자전략
        "인버스": ["인버스", "곱버스", "숏", "베어", "inverse"],
        "레버리지": ["레버리지", "2X", "3X", "불", "leverage"],
        "배당": ["배당", "고배당", "월배당", "인컴", "dividend"],
        "커버드콜": ["커버드콜", "covered", "프리미엄인컴"],
        "버퍼형": ["버퍼", "Buffer", "하방보호"],
        ...
        "퀄리티": ["퀄리티", "Quality", "우량주"],
        # 지역/국가
        "미국지수": ["S&P", "나스닥", "NASDAQ", "다우", "Russell", "미국대형"],
        "중국": ["중국", "차이나", "CSI", "항셍", "HSCEI", "상해", "심천"],
        "일본": ["일본", "닛케이", "니케이", "TOPIX", "엔화"],
        "유럽": ["유럽", "유로", "EURO", "독일", "DAX", "영국"],
        "인도·신흥": ["인도", "베트남", "신흥", "이머징", "브라질", "멕시코"],
        # 원자재/통화
        "금/은": ["금", "골드", "Gold", "은", "실버", "Silver", "귀금속"],
        "원유": ["원유", "WTI", "크루드", "오일", "Crude"],
        "천연가스": ["천연가스", "LNG", "가스", "Natural Gas"],
        "달러": ["달러", "USD", "Dollar", "미국달러", "달러선물"],
        "엔화": ["엔화", "JPY", "엔", "일본엔"],
        "VIX": ["VIX", "변동성", "공포지수", "Volatility"],
        # 기타
        "채권": ["채권", "국채", "회사채", "단기채", "장기채", "CD금리", "통안채", "KOFR", "머니마켓"],
